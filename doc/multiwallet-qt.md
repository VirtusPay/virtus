...
Only requiring some minor changes is virtus.cpp.
...
Changes to virtus.cpp
----------------------
virtus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
