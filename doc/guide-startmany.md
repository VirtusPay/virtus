...
[From the virtus github repo](https://github.com/virtuspay/virtus/blob/master/doc/masternode_conf.md)
...
## What about the virtus.conf file?

If you are using a `masternode.conf` file you no longer need the `virtus.conf` file. The exception is if you need custom settings (_thanks oblox_). In that case you **must** remove `masternode=1` from local `virtus.conf` file. This option should be used only to start local Hot masternode now.

## Update virtus.conf on server

If you generated a new masternode private key, you will need to update the remote `virtus.conf` files.

Shut down the daemon and then edit the file.

```nano .virtuscore/virtus.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `virtus.conf` file.
...
and comparing with the official explorer at https://explorer.virtus.org/chain/Virtus
...
Search your Masternodes on https://virtusninja.pl/masternodes.html
