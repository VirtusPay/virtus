...
This mechanism has been integrated into Bitcore-Node-Virtus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/virtuspay/insight-api-virtus#web-socket-api](https://github.com/virtuspay/insight-api-virtus#web-socket-api)
* API: [https://github.com/virtuspay/insight-api-virtus#instantsend-transactions](https://github.com/virtuspay/insight-api-virtus#instantsend-transactions)
...
By default, the Virtus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Virtus Core daemon:
