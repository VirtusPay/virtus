 ...
 *
 *   // network
 *   CVirtusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.virtus.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CVirtusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: VirtusNetwork
// //   -- signature requirements : Key1(User)
// class CVirtusNetworkVariable : public CGovernanceObject
// {
// private:
