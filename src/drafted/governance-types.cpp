...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "VirtusNetwork") type = VirtusNetwork;
    if(strType == "VirtusNetworkVariable") type = VirtusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == VirtusNetwork) s = "VirtusNetwork";
    if(type == VirtusNetworkVariable) s = "VirtusNetworkVariable";
