...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Virtus related functionality
...
/*
    ...
    allow endless transaction that would bloat Virtus and make it unusable. To
