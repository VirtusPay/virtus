    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("Virtus-light"), QVariant("light"));
/*    ui->theme->addItem(QString("Virtus-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("Virtus-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("Virtus-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("Virtus-traditional"), QVariant("trad"));
*/    
    /* Language selector */
