    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Virtus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Virtus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and virtus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Virtus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Virtus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Virtus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Virtus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Virtus addresses"));
    ...
    openAction->setStatusTip(tr("Open a virtus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Virtus Core help message to get a list with possible Virtus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Virtus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Virtus network", "", count));
    } else {
...
{
    QString strTitle = tr("Virtus Core"); // default title
