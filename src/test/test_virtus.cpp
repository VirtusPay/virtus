...
#define BOOST_TEST_MODULE Virtus Test Suite

#include "test_virtus.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_virtus_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
